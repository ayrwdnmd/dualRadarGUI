...
{
    float Speed = 0;
    UINT doorStatusLeft = 0;
    UINT doorStatusRight = 0;
    UINT Gear = 0;
    UINT ExtrLtgStsTurnIndrLe = 0;
    UINT ExtrLtgStsTurnIndrRi = 0;
    UINT sysfuncmode = 0;
};
